    ...
    return (
        <DashboardLayout>
            <Head title="Create Post">
                <link rel="stylesheet" type="text/css" href="https://unpkg.com/trix@2.0.0/dist/trix.css"></link>
            ...
            <form onSubmit={submit} className="container mx-auto max-w-7xl px-4 sm:px-6 md:px-8 mt-10">
                ...
                <div className="mt-10">
                    <div>
                        <label htmlFor="title" className="block text-sm font-medium text-gray-700">
                            Thumbnail
                        </label> <span className="text-red-600">{errors.thumnail && <span>{errors.thumnail}</span>}</span>
                        <div className="mt-1">
                            <input
                                type="file"
